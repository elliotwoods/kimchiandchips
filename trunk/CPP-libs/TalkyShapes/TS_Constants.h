...
#define TS_ERROR__DESERIALISE_MISMATCH_NVERTICES 3040

#define TS_ERROR__MSG_DESERIALISE_TOO_SHORT 3500
...
#define TS_ERROR__SHAPE_UPDATE_TYPE_MISMATCH 5100

#define TS_ERROR__SHAPE_ADD_ID_ALREADY_EXISTS 6000
...
enum TS_Message_Type {
    ...
    TS_MSG_SHAPES_PUSH_REQUEST = 20,
    TS_MSG_SHAPES_PUSH_ALL = 25,
